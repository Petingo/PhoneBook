...
public class PhoneBookView {
    ...
    public static String UPDATE_NUMBER_Q = "Please enter the new phone number.";
	...
	public static String IDLE_Q = 
      ...
      PhoneBookController.UPDATE_COMMAND + "\" to update a phone entry or \"" + 
      PhoneBookController.DELETE_COMMAND + "\" to delete a phone entry or \"" + 
    ...
    public static String PERSON_NOT_FOUND_Q = 
	  "Person not found.  Enter \"" + 
	  PhoneBookController.START_COMMAND + 
	  "\" to do more with the application or \"" + 
	  PhoneBookController.QUIT_COMMAND + "\" to end the application.";
	...
	public void changeView(String newState) {
        ...
        else if (newState.equals(PhoneBookModel.PERSON_NOT_FOUND_STATE)){
            System.out.println(PERSON_NOT_FOUND_Q);
        }
